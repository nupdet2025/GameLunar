...
gdjs.CENA_953_95ERROCode.asyncCallback23478116 = function (runtimeScene, asyncObjectsList) {
...
gdjs.CENA_953_95ERROCode.idToCallbackMap.set(23478116, gdjs.CENA_953_95ERROCode.asyncCallback23478116);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.CENA_953_95ERROCode.asyncCallback23478116(runtimeScene, asyncObjectsList)), 23478116, asyncObjectsList);
}
}
...
};gdjs.CENA_953_95ERROCode.asyncCallback23477084 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.CENA_953_95ERROCode.localVariables);
...
gdjs.CENA_953_95ERROCode.idToCallbackMap.set(23477084, gdjs.CENA_953_95ERROCode.asyncCallback23477084);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.CENA_953_95ERROCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.CENA_953_95ERROCode.asyncCallback23477084(runtimeScene, asyncObjectsList)), 23477084, asyncObjectsList);
}
}
...
};gdjs.CENA_953_95ERROCode.asyncCallback23480972 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.CENA_953_95ERROCode.localVariables);
...
gdjs.CENA_953_95ERROCode.idToCallbackMap.set(23480972, gdjs.CENA_953_95ERROCode.asyncCallback23480972);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.CENA_953_95ERROCode.asyncCallback23480972(runtimeScene, asyncObjectsList)), 23480972, asyncObjectsList);
}
}
...
};gdjs.CENA_953_95ERROCode.asyncCallback23489244 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.CENA_953_95ERROCode.localVariables);
...
gdjs.CENA_953_95ERROCode.idToCallbackMap.set(23489244, gdjs.CENA_953_95ERROCode.asyncCallback23489244);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.CENA_953_95ERROCode.asyncCallback23489244(runtimeScene, asyncObjectsList)), 23489244, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23482172);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(23484420);
}
}
}
if (isConditionTrue_0) {
